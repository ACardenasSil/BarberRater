...
class barber_profile2 extends StatelessWidget {
  ...
  static const routeName = '/barber_Profile2';
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(barber_profile2.routeName);
                },
                child: Text(
                  '',
                  style: TextStyle(
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                        image: DecorationImage(
                            image:
                                AssetImage("./assets/images/barberemp2.jpeg"),
                            fit: BoxFit.fitWidth),
                ...
                Expanded(
                  child: Container(
                    ...
                    color: Colors.blueAccent,
                    child: const Text(
                      'Hi, my name is Vincent Blake. I can take care of any face from a pencil stache to full viking beard. Just give us a call and I can setup an appointment with you right away.',
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: Colors.white,
                          fontSize: 12),
