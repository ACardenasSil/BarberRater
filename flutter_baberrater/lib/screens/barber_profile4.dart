...
class barber_profile4 extends StatelessWidget {
  const barber_profile4({super.key});

  static const routeName = '/barber_Profile4';
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(barber_profile4.routeName);
                },
                child: Text(
                  '',
                  style: TextStyle(
                ...
                Expanded(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                        image: DecorationImage(
                            image:
                                AssetImage("./assets/images/barberemp4.jpeg"),
                            fit: BoxFit.fitWidth),
