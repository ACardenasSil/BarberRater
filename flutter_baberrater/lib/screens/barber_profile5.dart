...
class barber_profile5 extends StatelessWidget {
  const barber_profile5({super.key});

  static const routeName = '/barber_Profile5';
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(barber_profile5.routeName);
                },
                child: Text(
                  '',
                  style: TextStyle(
